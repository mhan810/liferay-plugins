...
public class KaleoDefinitionTestCase extends TestCase {
	...
	public void testValidateCategorySpecificDefinition()
		throws Exception {
	...
	public void testValidateLegalMarketingDefinition()
		throws Exception {
	...
	public void testValidateMatchingForkAndJoins()
		throws Exception {
	...
	public void testValidateMultipleInitialStatesDefinedDefinition()
		...
		assertEquals(
			"Multiple initial states defined {start1, start2}", error);
	}
	...
	public void testValidateNoIncomingTransitionStateNodeDefinition()
		...
		assertEquals(
			"No incoming transition found for state state", error);
	}
	...
	public void testValidateNoIncomingTransitionTaskNodeDefinition()
		...
		assertEquals(
			"No incoming transition found for task task", error);
	}

	public void testValidateNoInitialStateDefinedDefinition()
		throws Exception {
	...
	public void testValidateNoTerminalStatesDefinition()
		throws Exception {
	...
	public void testValidateTransitions()
		throws Exception {
	...
	public void testValidateUnbalancedForkAndJoinNodes()
		throws Exception {
	...
	public void testValidateValidDefinition()
		throws Exception {
