...
public class UserNotificationMessageSender
	...
	private JSONObject populateJSONObject(
		...
		sb.append("/group/control_panel/manage/-/my_workflow_tasks/view/");
		sb.append(kaleoTaskInstanceToken.getKaleoTaskInstanceTokenId());
		sb.append("?controlPanelCategory=my");
		sb.append("&struts_action=/my_workflow_tasks/edit_workflow_task");
