 ...
 */
public abstract class BaseNotificationMessageGenerator
	...
	throws NotificationMessageGenerationException {
		...
		try {
			...
			Template template = TemplateManagerUtil.getTemplate(
				getTemplateManagerName(), templateId, notificationTemplate,
	...
	protected abstract String getTemplateManagerName();
