...
public class SolrQuerySuggester implements QuerySuggester {
	...
	public String[] suggestKeywordQueries(SearchContext searchContext, int max)
		...
		solrQuery.setFilterQueries(
			getFilterQueries(
				searchContext, SuggestionIndexer.FILTER_TYPE_SUGGESTION));
	...
	protected void searchTokenSimilars(
		...
		solrQuery.addFilterQuery(
			getFilterQueries(
				searchContext, DictionaryIndexer.FILTER_TYPE_DICTIONARY));
		...
		try {
			...
			for (int i = 0; i < numResults; i++) {
				...
				String strWeight = (String)solrDocument.get("spellCheckWeight");
