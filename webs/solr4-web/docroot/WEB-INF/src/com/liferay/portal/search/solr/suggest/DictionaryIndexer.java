...
public class DictionaryIndexer {
	...
	public static final int _UNICODE_BYTE_ORDER_MARK = 65279;
	...
	public void indexDictionary(
		...
		try {
			...
			if (line.charAt(0) == _UNICODE_BYTE_ORDER_MARK) {
	...
	protected Document getDictionaryEntryDocument(
		...
		document.addKeyword(Field.TYPE, _FILTER_TYPE_DICTIONARY);
	...
	protected String getUID(
		...
		sb.append(_FILTER_TYPE_DICTIONARY);
	...
	private static final String _FILTER_TYPE_DICTIONARY = "dictionary";
